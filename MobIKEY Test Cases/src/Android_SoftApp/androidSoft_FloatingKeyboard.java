...
public class androidSoft_FloatingKeyboard extends JUnitTestReporter {
...
//        driver.findElement(By.xpath("//*[@class='android.widget.ImageButton' and ./parent::*[@id='mode_floating']]")).click();
//        driver.findElement(By.xpath("//*[@id='keyboardView']")).click();
//        driver.findElement(By.xpath("//*[@class='android.widget.ImageButton' and ./parent::*[@id='mode_split']]")).click();
