...
import org.junit.runner.notification.Failure;
	...
	public class AndroidSoft_Addproxy_ChangePWD extends JUnitTestReporter {
	...
	public void testSoftApp_Android_StartSess_EndSess() {
	    ...
	    //Add new proxy profile
	       ...
	       // driver.findElement(By.xpath("//*[@text='Remember Credentials']")).click(); //Remember Credentials
	        ...
	        driver.findElement(By.xpath("//*[@id='password']")).sendKeys("Route123");
	        driver.findElement(By.xpath("//*[@text='Change password after successful login']")).click();
	        driver.findElement(By.xpath("//*[@id='new_password']")).sendKeys("Route321");
	        driver.findElement(By.xpath("//*[@id='retype_password']")).sendKeys("Route321");
	        driver.findElement(By.xpath("//*[@text='Login']")).click();
