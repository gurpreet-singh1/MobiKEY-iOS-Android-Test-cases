...
public class AndroidSoft_10Registrations extends JUnitTestReporter {
    ...
    public void testUntitled() {
    	//1
        new WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='menu_settings_login']")));
        driver.findElement(By.xpath("//*[@id='menu_settings_login']")).click();
    ...
    public void tearDown() {
    	System.out.println("10 Registrations complete.");
    }
}